describe('wild-proxy-integration-tests', function () {
  ...
  it('test the config options, does an end-to-end http proxy run, confirms the steps, we then stop a destination and check the error is handled', function (done) {
    ...
    setTimeout(function(){
      ...
      wildProxy.listen()
        ...
        .then(function(response){
          ...
          expect(response.response.statusCode).to.be(500);
